"""
    PYTHON: CUSTOM MODULE EXAMPLE

    Module names (file) the best practices ask to use all-lowercase and, if needed, underscore to separate words. So the filename should be snake_case!
"""
