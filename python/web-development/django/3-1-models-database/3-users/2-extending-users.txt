...
- -------------- I NEED TO REVIEW THIS ----- TO OLD APPROACH FROM MY INITIAL STUDIES ------------- -
...
EXTENDING THE USER FEATURES:
    ...
    >> USER PROFILE PAGE:
        ...
        /python/web-development/django/3-1-models-database/3-users/3-extending-users-with-profile.txt
