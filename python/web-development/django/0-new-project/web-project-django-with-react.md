...
### 1.3) Front-end
1. IDE, framework setup:  [VSCode for React](javascript/Web-development/frontend/React/IDE-softwares/vscode/temp.md) or [PyCharm for React](javascript/Web-development/frontend/React/IDE-softwares/pycharm/temp.md).
2. React installation (and its dependencies): /vault/javascript/web-development/frontend/xxxxxxxxxxxx
3. (Optional) CSS Framework: [Bootstrap](web-development/frontend/CSS/css-libraries-frameworks/bootstrap/_about.md) or [Tailwind](install-and-integration.md) or  [Bulma](web-development/frontend/CSS/css-libraries-frameworks/bulma/_about.md).
