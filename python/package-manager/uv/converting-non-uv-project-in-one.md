...
==Be aware!==
Avoid to use the *uv pip install -r requirements.txt* command once it will not update automatically your *pyproject.toml*, and to keep a project using the *requirements.txt* method is not reliable in long-term.
