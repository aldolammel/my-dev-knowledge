...
VIRTUAL ENVIRONMENT:
    ...
    >> There is 2 methods to create a virtual environment by terminal:
        ...
        C) by UV package manager and resolver (HIGHLY RECOMMENDED);
            ...
            UBUNTU:
                $ sudo apt install python3-venv
                    # In the project folder:
                        $ python3 -m venv .<venv_name>  <-- add that dot "." to make it a hidden
                                                            folder and be automatically ignore by gitignore file.
