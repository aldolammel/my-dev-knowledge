"""
    SUPER CAREFUL!
    DON'T replace/update this code file WITHOUT to consider line by line!
"""
...
INSTALLED_APPS = [
    ...
    #"rest_framework", # TODO: uncomment if Pagex available!
    #"rosetta",  # TODO: uncomment if multilingual!
    #"parler",  # TODO: uncomment if multilingual!
    #"apps.pagex",  # TODO: uncomment if Pagex available!
...
MIDDLEWARE = [
    ...
    # TODO: uncomment if Pagex available:
