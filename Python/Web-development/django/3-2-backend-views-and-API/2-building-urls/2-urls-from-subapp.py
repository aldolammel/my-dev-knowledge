"""
    ...
    >> This file depends of the its relationship with 'urls.py' in core-folder (another file):
        ...
        /Python/Web-development/django/3-2-backend-views-and-API/2-building-urls/1-urls-from-core-folder.py
...
"""
    ...
    /Python/Web-development/django/3-2-backend-views-and-API/2-building-urls/path-converters.txt
