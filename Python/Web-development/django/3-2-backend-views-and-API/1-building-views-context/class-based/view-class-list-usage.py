...
class RecipesListView(ListView):  # This 'View' in classname is a convention.
    ...
    # def get_queryset(self):
        # /Python/Web-development/django/3-2-backend-views-and-API/1-building-views-context/class-based/QuerySet-filtering.py
        # /Python/Web-development/django/3-2-backend-views-and-API/1-building-views-context/class-based/QuerySet-counting.py
        # /Python/Web-development/django/3-2-backend-views-and-API/1-building-views-context/class-based/QuerySet-aggregation.py
        # /Python/Web-development/django/3-2-backend-views-and-API/1-building-views-context/class-based/QuerySet-other-formats.py
