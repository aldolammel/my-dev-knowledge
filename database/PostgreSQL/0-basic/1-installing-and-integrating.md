POSTGRESQL: INSTALLATION (It's NOT a db creation)
            ...
            # Test it:
                ...
                # If you get a annoying message about i386 architecture, just do it to force postgresql doesn't look for other than not amd64 one:
                    ...
                    $ sudo nano /etc/apt/sources.list.d/pgdg.sources
                        ...
                        Suites: ...
                        Components: ...
                        Architectures: amd64 i386                        # <-- Remove i386 from here
                        Signed-By: ...


    PRE.2) Check if there's the postgresql in the current machine:
    ...
    1) Installation:
        ...
        >> Case you also wanna a db interface management, using pgAdmin (RECOMMENDED):
            ...
            UBUNTU:
                ...
                1.3) Create the repository configuration file:
                    Check the command in the site!
    ...
    2) Integration:
        ...
        2.1) Add a new server (or Register);
        2.2) In General tab, in Name set it as (convention):
        ...
        2.3) In Connection tab, in host set it as 'localhost';
