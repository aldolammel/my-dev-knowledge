...
POSTGRESQL: UPDATING
    ...
    UBUNTU - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
        ...
        PRE) Make sure you got the postgresql repository installed:
            ./installing-and-integrating.txt

        1) Update the repository and upgrade the postgresql if new version is available:
