VUE: RE-INSTALLING A NEW COPY (OF VUE OR ENTIRE PROJECT)
    ...
    1) Which scenario you are:
        ...
        1B) Install Vue in a new project (skip this roadmap);
        ...
        1B) Install Vue in a new project - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
        ...
        1D) Re-installing an entire front-end existing project - - - - - - - - - - - - - - - - - - -
            ...
            1D.2) Dependencies reinstallation method:
            ...
            1D.7) Clean up some useless stuff:
