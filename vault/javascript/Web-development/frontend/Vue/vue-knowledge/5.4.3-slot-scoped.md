...
VUE.JS COMPONENTS: SCOPED SLOTS, THE WAY TO USE SLOTS WITH FOR-LOOPS
    ...
    >> Basic about slots:
        /vault/javascript/web-development/frontend/Vue/vue-knowledge/5.4-slot.txt
    ...
    However, we can pass attributes to a slot outlet just like passing props to a component:
        ...
        /vault/javascript/web-development/frontend/Vue/vue-knowledge/vue-component-slot-scoped.png
