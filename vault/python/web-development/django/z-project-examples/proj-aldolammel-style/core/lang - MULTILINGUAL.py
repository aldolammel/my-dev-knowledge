...
S_I_ATTK_DT_NAME = _('Attack Note')  # DT = Detail page;
...
TX_FDBK_PROFILE_SUCC_PWD_UPDATED = _('Your password was changed successfully.')
...
TX_PROFILE_2_FORM = _('To represent a business')
...
TX_HELP_USER_EMAIL = _('We do NOT share your email under any circumstances.')
