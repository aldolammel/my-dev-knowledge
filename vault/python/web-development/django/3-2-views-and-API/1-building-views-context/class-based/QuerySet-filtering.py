...
class RecipesView(View):
    ...
    def get_queryset(self):
        ...
        return Recipe.objects.filter(is_published=True, id__gt=3)
        ...
        return Recipe.objects.filter(is_published=True, category__name__iexact='salad')
        ...
        return Recipe.objects.filter(is_published=True, category__name__icontains='soup')
