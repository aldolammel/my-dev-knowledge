...
- Front-end:
	- **Vue.js** project:
		- Update Vue: [javascript/Web-development/frontend/Vue/2-updating-removing/updating-vue](javascript/Web-development/frontend/Vue/2-updating-removing/updating-vue.md)
...
- Using env vars:
	- With Django: [python/web-development/django/3-1-models-database/env-vars-on-django](python/web-development/django/3-1-models-database/env-vars-on-django.md)
