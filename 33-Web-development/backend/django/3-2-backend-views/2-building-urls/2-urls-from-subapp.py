...
"""
    ...
    /33-Web-development/backend/django/3-2-backend-views/2-building-urls/urls-from-config-folder.py

    
    ABOUT PATH CONVERTERS:
    /33-Web-development/backend/django/3-2-backend-views/2-building-urls/path-converters.txt
