...
class RecipesListView(ListView):  # This 'View' in classname is a convention.
    ...
    # def get_queryset(self):
        # /33-Web-development/backend/django/3-2-backend-views/1-building-views-context/class-based/QuerySet-filtering.py
        # /33-Web-development/backend/django/3-2-backend-views/1-building-views-context/class-based/QuerySet-counting.py
        # /33-Web-development/backend/django/3-2-backend-views/1-building-views-context/class-based/QuerySet-aggregation.py
        # /33-Web-development/backend/django/3-2-backend-views/1-building-views-context/class-based/QuerySet-other-formats.py
