...
# More about: /33-Web-development/backend/django/3-1-backend-models-database/_constants-map.py
VAL_PROFILE_NAME_MAXLNGH = 20


# E.g. in /config-folder/language.py:
# More about: /33-Web-development/backend/django/8-translate-and-internationalization/language-file-example.py
