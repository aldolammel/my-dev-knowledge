PROGRAMMING CONCEPTS > ARCHITECTURE: CLIENT-SERVER
    ...
    Charts:
        ...
        ./architecture-client-server-using-api.png

    Benefits:
        - All the data's stored on the servers, which generally have better security controls;
        - Since data storage is centralized, updates to that data are much easier to administer;
