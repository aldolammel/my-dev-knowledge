...
COMPOSITION API APPROACH: REF() AND REACTIVE()
    ...
    In Vue.js Composition API, ref() and reactive() are both used to create reactive data, but they serve different purposes:

        
        >> REF()
            
            For primitive values (strings, numbers, booleans) and when you need a single reactive value:
