/*
  THIS FILE: /project_django/frontend/src/stores/menus.js

  It's responsible to cache/store all Menus data incoming from Django CMS.
...
const PATH = "/api/menus"; // It's also partially declared in /apps/pagex/constants.py
