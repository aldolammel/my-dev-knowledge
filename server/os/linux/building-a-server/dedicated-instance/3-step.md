DEBIAN/UBUNTU > BUILDING UP A VPS: DEPLOYING A WEB APP
    ...
    4) Install Python, and its crucial tools:
        ...
        4.1) Installing:
            ...
            >> Or for NON-UV users:
                /python/1-python-installation/_install.md


    5) Installing the database:

        >> Using SQLite3 (Python bundled db solution):
            /database/SQLite/0-basic/1-installing-and-integrating.md
        ...
        6.1) Installation:
            How do you installed the project's WSGI solution during the development phase?
                ...
                6.1A) Globally - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
                    ...
                    >> For Python projects:
                        >> Gunicorn solution:
                            /server/_languages-server-tools/python/gunicorn/install.txt
    ...
    8) Testing the app:
        ...
        8.1) Preparing a testing file:
            ...
            >> For Python > Flask projects:
                /python/web-development/flask/z_examples/_minimal-code.py
